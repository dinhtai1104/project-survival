...
public class EasingDemoPreviewWindow : EditorWindow {
    ...
    private float _overshootOrAmplitude = DOTween.defaultEaseOvershootOrAmplitude; // Overshoot or amplitude
    private float _period = DOTween.defaultEasePeriod; // period
