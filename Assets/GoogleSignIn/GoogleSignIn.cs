  ...
  static GoogleSignIn() {
      ...
      set {
        ...
        if (theInstance == null || theConfiguration == value || theConfiguration == null) {
                theConfiguration = value;
                    Debug.Log("=>>>INIT GOOGLESIGNIN " + (theConfiguration != null));
    ...
    public static GoogleSignIn DefaultInstance {
      get {
        if (theInstance == null) {
#if UNITY_ANDROID 
                    Debug.Log("SIGN IN WITH GOOGLE2 "+Configuration.WebClientId);
