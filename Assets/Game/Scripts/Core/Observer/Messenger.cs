...
internal static class Messenger
{
    ...
    public static void OnListenerRemoving(Dictionary<EventKey, Delegate> eventTable, EventKey eventType, Delegate listenerBeingRemoved)
    {
        ...
        if (eventTable.ContainsKey(eventType))
        {
            ...
            if (d == null)
            {
                Debug.LogWarning($"Attempting to remove listener with for event type \"{eventType}\" but current listener is null.");
            }
        ...
        {
            Debug.LogWarning($"Attempting to remove listener for type \"{eventType}\" but Messenger doesn't know about this event type.");
        }
    }
    ...
    internal static void AddListener(EventKey quickEquip)
    {
        throw new NotImplementedException();
    }

    internal static void Broadcast(EventKey changeLanguage, object updateLanguage)
    {
        throw new NotImplementedException();
    }
