...
public class Enemy22SkillTask : SkillTask
{
    ...
    public ValueConfigSearch bullet_ChaseRate;
    ...
    public override async UniTask Begin()
    {
        ...
        bullet_ChaseRate = bullet_ChaseRate.SetId(Caster.gameObject.name);
    ...
    private void ReleaseBullet()
    {
        ...
        bullet.SetMaxHit(1);
        bullet.Movement.TrackTarget(bullet_ChaseRate.FloatValue, target.GetMidTransform());
        bullet.Play();
    }
}