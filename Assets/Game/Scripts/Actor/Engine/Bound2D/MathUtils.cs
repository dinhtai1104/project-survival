...
namespace Engine
{
    public static class MathUtils
    {
        ...
        public static Vector3 RandomPointInBound2D(Bound2D bound, float offsetXLow = 0f, float offsetXHigh = 0f, float offsetYLow = 0f, float offsetYHigh = 0f)
        {
            Vector3 v = Vector3.zero;
        ...
        public static Vector3 Bound2D(Vector3 vec, Bound2D bound, float offsetXLow = 0f, float offsetXHigh = 0f, float offsetYLow = 0f, float offsetYHigh = 0f)
        {
        ...
        public static int RoundUp(float value, int rightDecimalPoints = 1)
        {
            ...
            return (int)Mathf.Ceil(value / trueDigit) * trueDigit;
        }
