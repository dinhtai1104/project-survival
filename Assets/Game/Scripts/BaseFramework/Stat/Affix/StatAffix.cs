...
public class StatAffix : BaseAffix
{
    ...
    public StatAffix(StatKey statName, StatModifier modifier)
    {
        StatName = statName;
        _modifier = modifier;
        SetDescriptionKey();
    }
    public StatAffix(AttributeStatModifier attribute) : this(attribute.StatKey, attribute.Modifier)
    {
    }
    public StatAffix()
    {
    ...
    public StatKey StatName { get => _statName; set => _statName = value; }
    ...
    public override void OnRemoveFromItem(EquipableItem item)
    {
        base.OnRemoveFromItem(item);
        Stats?.RemoveModifier(StatName, _modifier);
    }
    public override void OnAddToItem(EquipableItem item)
    {
        base.OnAddToItem(item);
        Stats?.AddModifier(StatName, _modifier, item);
    }
