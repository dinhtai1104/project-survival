...
namespace RVO
{
    ...
    public struct RVOMath
    {
         ...
         */
        public static float abs(Vector2RVO vector)
        {
         ...
         */
        public static float absSq(Vector2RVO vector)
        {
         ...
         * is to be computed.</param>
         */
        public static Vector2RVO normalize(Vector2RVO vector)
        {
         ...
         * matrix.</param>
         */
        internal static float det(Vector2RVO vector1, Vector2RVO vector2)
        {
         ...
         * be calculated.</param>
         */
        internal static float distSqPointLineSegment(Vector2RVO vector1, Vector2RVO vector2, Vector2RVO vector3)
        {
         ...
         * calculated.</param>
         */
        internal static float leftOf(Vector2RVO a, Vector2RVO b, Vector2RVO c)
        {
            return det(a - c, b - a);
        }
