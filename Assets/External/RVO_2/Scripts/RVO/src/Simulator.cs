...
namespace RVO
{
    ...
    public class Simulator
    {
         ...
         * agent.</param>
         */
        public int addAgent(Vector2RVO position)
        {
         ...
         * this agent.</param>
         */
        public int addAgent(Vector2RVO position, float neighborDist, int maxNeighbors, float timeHorizon, float timeHorizonObst, float radius, float maxSpeed, Vector2RVO velocity)
        {
            Agent agent = new Agent();
            agent.id_ = s_totalID;
            s_totalID++;
         ...
         * </remarks>
         */
        public int addObstacle(IList<Vector2RVO> vertices)
        {
            if (vertices.Count < 2)
            {
                return -1;
         ...
         */
        public Vector2RVO getAgentPosition(int agentNo)
        {
         ...
         */
        public Vector2RVO getAgentPrefVelocity(int agentNo)
        {
         ...
         */
        public Vector2RVO getAgentVelocity(int agentNo)
        {
         ...
         * retrieved.</param>
         */
        public Vector2RVO getObstacleVertex(int vertexNo)
        {
         ...
         */
        public bool queryVisibility(Vector2RVO point1, Vector2RVO point2, float radius)
        {
            return kdTree_.queryVisibility(point1, point2, radius);
        }

        public int queryNearAgent(Vector2RVO point, float radius)
        {
            if (getNumAgents() == 0)
                return -1;
         ...
         */
        public void setAgentDefaults(float neighborDist, int maxNeighbors, float timeHorizon, float timeHorizonObst, float radius, float maxSpeed, Vector2RVO velocity)
        {
            if (defaultAgent_ == null)
            {
         ...
         * position.</param>
         */
        public void setAgentPosition(int agentNo, Vector2RVO position)
        {
         ...
         */
        public void setAgentPrefVelocity(int agentNo, Vector2RVO prefVelocity)
        {
         ...
         * velocity.</param>
         */
        public void setAgentVelocity(int agentNo, Vector2RVO velocity)
        {
