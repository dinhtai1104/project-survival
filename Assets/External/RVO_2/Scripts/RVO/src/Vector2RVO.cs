...
namespace RVO
{
    ...
    public struct Vector2RVO
    {
         ...
         * specified xy-coordi  nates.</summary>
         *
         ...
         * </param>
         */
        public Vector2RVO(float x, float y)
        {
            x_ = x;
            y_ = y;
        }

        public Vector2RVO(Vector2 e)
        {
            x_ = e.x;
            y_ = e.y;
        }
         ...
         */
        public static float operator *(Vector2RVO vector1, Vector2RVO vector2)
        {
         ...
         */
        public static Vector2RVO operator *(float scalar, Vector2RVO vector)
        {
         ...
         * <param name="scalar">The scalar value.</param>
         */
        public static Vector2RVO operator *(Vector2RVO vector, float scalar)
        {
            return new Vector2RVO(vector.x_ * scalar, vector.y_ * scalar);
        }
         ...
         * <param name="vector2">The second two-dimensional vector.</param>
         */
        public static Vector2RVO operator +(Vector2RVO vector1, Vector2RVO vector2)
        {
            return new Vector2RVO(vector1.x_ + vector2.x_, vector1.y_ + vector2.y_);
        }
         ...
         * <param name="vector">The two-dimensional vector.</param>
         */
        public static Vector2RVO operator -(Vector2RVO vector)
        {
            return new Vector2RVO(-vector.x_, -vector.y_);
        }
    }
}
