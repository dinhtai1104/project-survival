...
namespace RVO
{
    class Circle
    {
        ...
        IList<Vector2RVO> goals;

        Circle()
        {
            goals = new List<Vector2RVO>();
        }
        ...
        void setupScenario()
        {
             ...
             * added.
             */
            Simulator.Instance.setAgentDefaults(15.0f, 10, 10.0f, 10.0f, 1.5f, 2.0f, new Vector2RVO(0.0f, 0.0f));
            ...
            for (int i = 0; i < 250; ++i)
            {
                Simulator.Instance.addAgent(200.0f *
                    new Vector2RVO((float)Math.Cos(i * 2.0f * Math.PI / 250.0f),
        ...
        void setPreferredVelocities()
        {
            ...
            for (int i = 0; i < Simulator.Instance.getNumAgents(); ++i)
            {
                Vector2RVO goalVector = goals[i] - Simulator.Instance.getAgentPosition(i);
