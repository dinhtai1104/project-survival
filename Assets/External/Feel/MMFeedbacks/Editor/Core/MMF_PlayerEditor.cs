...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_PlayerEditor : Editor
    {
        ...
        protected SerializedProperty _mmfeedbacksCanPlayOnDisable;
        ...
        protected virtual void Initialization()
        {
            ...
            _mmfeedbacksCanPlayOnDisable = serializedObject.FindProperty("CanPlayOnDisable");
        ...
        protected virtual void DrawSettingsDropDown()
        {
            ...
            if (_settingsMenuDropdown)
            {
                ...
                EditorGUILayout.PropertyField(_mmfeedbacksCanPlayOnDisable);
