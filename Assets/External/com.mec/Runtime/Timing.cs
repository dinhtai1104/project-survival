...
public static class MECExtensionMethods2
{
    ...
    {
        yield return com.mec.Timing.WaitForSeconds(timeToDelay);
    ...
    {
        while (com.mec.Timing.MainThread != System.Threading.Thread.CurrentThread ||
    ...
    {
        while (com.mec.Timing.MainThread != System.Threading.Thread.CurrentThread || (gameObject1 && gameObject1.activeInHierarchy &&
    ...
    public static IEnumerator<float> CancelWith(this IEnumerator<float> coroutine, System.Func<bool> condition)
    {
        ...
        while (com.mec.Timing.MainThread != System.Threading.Thread.CurrentThread || (condition() && coroutine.MoveNext()))
            yield return coroutine.Current;
    }
    ...
    {
        while (com.mec.Timing.MainThread == System.Threading.Thread.CurrentThread && gameObject)
        {
            ...
            {
                yield return com.mec.Timing.WaitForOneFrame;
            }
        }
    }
    ...
    {
        while (com.mec.Timing.MainThread == System.Threading.Thread.CurrentThread && gameObject1 && gameObject2)
        {
    ...
    public static IEnumerator<float> PauseWith<T>(this IEnumerator<float> coroutine, T script) where T : MonoBehaviour
    {
        ...
        while (com.mec.Timing.MainThread == System.Threading.Thread.CurrentThread && myGO && myGO.GetComponent<T>() != null)
        {
    ...
    /// <returns>The modified coroutine handle.</returns>
    public static IEnumerator<float> KillWith(this IEnumerator<float> coroutine, com.mec.CoroutineHandle otherCoroutine)
    {
    ...
    {
        return Superimpose(coroutineA, coroutineB, com.mec.Timing.Instance);
    }
    ...
    /// <returns>The modified coroutine handle.</returns>
    public static IEnumerator<float> Superimpose(this IEnumerator<float> coroutineA, IEnumerator<float> coroutineB, com.mec.Timing instance)
    {
