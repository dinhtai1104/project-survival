...
class KEY(object):
    ...
    ANDROID_IDENTIFIER = "ANDROID_IDENTIFIER"
    ...
    BUILD_FILE_SYMBOLS = "BUILD_FILE_SYMBOLS"
    BUILD_FILE_SHRINK_SYMBOLS = "BUILD_FILE_SHRINK_SYMBOLS"
    BUILD_FILE_MAPPING = "BUILD_FILE_MAPPING"
    # Git commit info
