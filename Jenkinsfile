        ...
        stage('Publish') {
            ...
            steps {
                script {
                    ...
                    if(BUILD_TARGET.toLowerCase().contains("android") && env.BRANCH_NAME.toLowerCase().contains("production"))
                    {
                        try {
                          ...
                          //      trackName: 'internal',
                           ...
                           //     deobfuscationFilesPattern: "**/build/Android/${build_file_mapping}.txt",
                    ...
                    if (BUILD_TARGET.toLowerCase().contains("ios"))
                    {
